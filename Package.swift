...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            checksum: "ffe324544c5cf8b72ed1f201bdf8ce4f5844286cd07742c04e676c4912de2393"
        ),
        .binaryTarget(
            name: "TXFFmpeg",
            url: "https://liteav.sdk.qcloud.com/download/spm/12.4/professional/TXFFmpeg.xcframework.zip",
            checksum: "3ce59f9d07073465d556551e88752b74f335e4133530e404338092cf9c546791"
        ),
        .binaryTarget(
            name: "TXSoundTouch",
            url: "https://liteav.sdk.qcloud.com/download/spm/12.4/professional/TXSoundTouch.xcframework.zip",
            checksum: "a611b73cce51cfffc6ee49cb32703ca51c6abf25cfe522dda0e29468dbc38a02"
        ),
        .binaryTarget(
            name: "TXLiteAVSDK_ReplayKitExt",
            url: "https://liteav.sdk.qcloud.com/download/spm/12.4/professional/TXLiteAVSDK_ReplayKitExt.xcframework.zip",
            checksum: "c3db5acb4e569812cee7740402f67f8412c3353857ced86f18a5881bef7dba5e"
        ),
        .target(
            name: "Professional_SwiftPM",
            dependencies: [
