...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            checksum: "e36366ca6a6322bbe217d6667c0a208d90bbceeb357b64335fbb5932b663a7b8"
        ),
        .binaryTarget(
            name: "TXFFmpeg",
            url: "https://liteav.sdk.qcloud.com/download/spm/12.8/professional/TXFFmpeg.xcframework.zip",
            checksum: "c1a2008810533198a0e43c2bf2cd9af93b761613405af8ee3ec2fcf964735289"
        ),
        .binaryTarget(
            name: "TXSoundTouch",
            url: "https://liteav.sdk.qcloud.com/download/spm/12.8/professional/TXSoundTouch.xcframework.zip",
            checksum: "45b59b5b7e2e302f8bfbfbf152c4dc04b451d3a451639180573d19c38224ff53"
        ),
        .binaryTarget(
            name: "TXLiteAVSDK_ReplayKitExt",
            url: "https://liteav.sdk.qcloud.com/download/spm/12.8/professional/TXLiteAVSDK_ReplayKitExt.xcframework.zip",
            checksum: "7e053e5f03ef6fa869d0ff457937bebc07beba32572c51132a9e3aa2a2294889"
        ),
        .target(
            name: "Professional_SwiftPM",
            dependencies: [
